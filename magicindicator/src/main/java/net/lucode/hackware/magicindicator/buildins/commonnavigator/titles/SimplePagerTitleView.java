...
public class SimplePagerTitleView extends TextView implements IMeasurablePagerTitleView {
    ...
    protected float mDeselectedSize;
...
//        int padding = UIUtil.dip2px(context, 10);
    ...
    public int getContentRight() {
        ...
        getPaint().getTextBounds(longestString, 0, longestString.length(), bound);
        int contentWidth = bound.width();
//        Log.i("www","getLeft():"+getLeft());
//        Log.i("www","getWidth():"+getWidth());
//        Log.i("www","contentWidth:"+contentWidth);

//        Log.i("www","======"+(getLeft() + getWidth() / 2 + contentWidth / 2));
        return getLeft() + getWidth() / 2 + contentWidth / 2;
    }
    ...
    public void setDeselectedSize(int mDeselectedSize) {
        this.mDeselectedSize = mDeselectedSize;
    }
