...
public class CustomCircleProgress extends ProgressBar{
    ...
    //定义一些属性常量
    private static final int PROGRESS_DEFAULT_COLOR = 0XFFFFC700;//默认圆(边框)的颜色0XFFFBFBFB
    private static final int PROGRESS_REACHED_COLOR = 0XFFE8616A;//进度条的颜色0XFFff083f
    private static final int PROGRESS_REACHED_HEIGHT = 3;//进度条的高度
    private static final int PROGRESS_DEFAULT_HEIGHT = 3;//默认圆的高度
    private static final int PROGRESS_RADIUS = 10;//圆的半径
