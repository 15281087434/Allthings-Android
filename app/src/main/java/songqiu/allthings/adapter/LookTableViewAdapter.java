...
public class LookTableViewAdapter extends FragmentPagerAdapter {
    private List<Fragment> mFragment;
//    private List<String> mTabName;
    private List<TabClassBean> list;

    public LookTableViewAdapter(FragmentManager fm, List<Fragment> fragmentList, List<TabClassBean> list) {
        super(fm);
