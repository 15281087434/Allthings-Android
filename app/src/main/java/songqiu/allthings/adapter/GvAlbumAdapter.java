...
public class GvAlbumAdapter extends BaseAdapter {
    ...
    private int maxNum;
    public GvAlbumAdapter(Context mContext, LinkedList<String> gvList,int maxNum) {
        this.gvList = gvList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        GvVH viewHolder;
        if(convertView==null){
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_gv_advise,null);
            viewHolder = new GvVH();
        ...
        if(position==gvList.size()-1){
            ...
            if(gvList.size()>maxNum) {
                ...
                viewHolder.img.setImageResource(R.mipmap.icon_setting_add_img);
