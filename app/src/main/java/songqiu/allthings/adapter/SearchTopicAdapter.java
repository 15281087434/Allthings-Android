...
public class SearchTopicAdapter extends RecyclerView.Adapter {
    ...
    public SearchTopicAdapter(Context context,List<HomeGambitHotBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_home_tab_gambit,viewGroup,false);
